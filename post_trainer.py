...
class PostTrainer(Trainer):
    ...
    def load_metatrain(self):
        ...
        incompatible = self.ent_init.load_state_dict(state['ent_init'], strict=False)
        if incompatible.missing_keys or incompatible.unexpected_keys:
            self.logger.info('loaded ent_init with non-strict state_dict; missing keys: {}; unexpected keys: {}'.format(
